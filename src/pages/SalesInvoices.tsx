                      ...
                      <PopoverTrigger asChild>
                        <Button variant="outline" className="min-w-[200px] justify-start">
                          ...
                          {filters.dateRange?.from || filters.dateRange?.to ? (
                            `${filters.dateRange.from ? format(new Date(filters.dateRange.from), "dd/MM/yyyy", { locale: tr }) : "Başlangıç"} - ${filters.dateRange.to ? format(new Date(filters.dateRange.to), "dd/MM/yyyy", { locale: tr }) : "Bitiş"}`
                          ) : (
                            "Tarih Aralığı"
                          )}
                        </Button>
