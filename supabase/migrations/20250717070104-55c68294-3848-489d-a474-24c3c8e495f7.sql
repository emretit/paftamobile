...
ALTER TABLE public.monthly_financials DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.opportunities DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.opex_matrix DISABLE ROW LEVEL SECURITY;
...
ALTER TABLE public.sales_tracking DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.service_activities DISABLE ROW LEVEL SECURITY;
