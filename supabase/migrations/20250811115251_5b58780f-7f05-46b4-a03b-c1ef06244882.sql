-- Quote template JSON'unu templates tablosuna ekle
-- Önce bir test user_id ile ekliyoruz (daha sonra RLS policies ile kullanıcı kendi template'ini görecek)
