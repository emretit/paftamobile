  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={h1}>PAFTA'a Hoş Geldiniz!</Heading>
        ...
        <Text style={text}>
          {company_name && `${company_name} şirketi adına `}PAFTA İş Yönetim Sistemi'ne kayıt olduğunuz için teşekkür ederiz. 
        ...
        <Text style={text}>
          PAFTA ile işlerinizi kolayca yönetebilir, müşterilerinizi takip edebilir ve işletmenizi 
